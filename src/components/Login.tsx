...
const Login = () => {
  ...
  return (
    <form className=' w-[80%] md:w-[40%] lg:w-[30%] xl:w-[20%] border-2 flex flex-col justify-center items-center mx-auto mt-[8rem] rounded-md shadow-md py-5'>
      ...
      <h1 className='text-[1.2rem] font-bold text-blue-500'>REMS Login</h1>
      ...
      <button 
        ...
        className='bg-blue-600 active:bg-blue-700 hover:bg-blue-400 text-white text-[0.9rem] font-bold px-5 py-2 rounded-xl'
      >
        Login
      </button>
